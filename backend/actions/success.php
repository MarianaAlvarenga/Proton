...
if ($external_reference) {
    ...
    if (ctype_digit($external_reference)) {
        ...
        $frontend = "https://spokesman-mixed-floppy-special.trycloudflare.com";
    ...
    $redirect = "https://explained-branches-post-lease.trycloudflare.com/backend/actions/completePurchase.php?from=mp";
