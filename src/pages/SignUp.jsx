...
const SignUp = () => {
  ...
  useEffect(() => {
    const fetchRoles = async () => {
      try {
        const res = await fetch("https://explained-branches-post-lease.trycloudflare.com/backend/actions/getRoles.php");
    ...
    const fetchEspecialidades = async () => {
      try {
        const res = await fetch("https://explained-branches-post-lease.trycloudflare.com/backend/actions/getEspecialidades.php");
        const data = await res.json();
  ...
  const handleSubmit = async (e) => {
    ...
    const endpoint = isEditMode
      ...
      : "https://explained-branches-post-lease.trycloudflare.com/backend/actions/authentication.php";
