...
const ProfileUser = () => {
        ...
        const fetchUser = async () => {
            try {
                const response = await fetch(
                    "https://tool-crossing-ranges-flour.trycloudflare.com/backend/actions/getUserById.php",
                    {
                        method: "POST",
    ...
    useEffect(() => {
        const fetchMascotas = async () => {
            try {
                const response = await fetch(
                    `https://tool-crossing-ranges-flour.trycloudflare.com/backend/actions/getPetsByClientId.php?userId=${id_usuario}`
                );
                const data = await response.json();
    ...
    useEffect(() => {
        const fetchEspecialidades = async () => {
            try {
                const response = await fetch(
                    "https://tool-crossing-ranges-flour.trycloudflare.com/backend/actions/getEspecialidades.php"
                );
                const data = await response.json();
    ...
    const handleActualizarMascota = async () => {
        ...
        if (mascotaEdit.id_mascota) {
            try {
                const response = await fetch(
                    "https://tool-crossing-ranges-flour.trycloudflare.com/backend/actions/updatePet.php",
                    {
                        method: "POST",
                        headers: { "Content-Type": "application/json" },
            ...
            try {
                ...
                const response = await fetch(
                    "https://tool-crossing-ranges-flour.trycloudflare.com/backend/actions/addPet.php",
                    {
                        method: "POST",
                        headers: { "Content-Type": "application/json" },
