...
const ProfileUser = () => {
        ...
        const fetchData = async () => {
            ...
            try {
                const res = await fetch(
                    "https://bean-burner-ensures-institutes.trycloudflare.com/backend/actions/getUserById.php",
                    {
                        method: "POST",
                ...
                try {
                    const resEsp = await fetch("https://bean-burner-ensures-institutes.trycloudflare.com/backend/actions/getEspecialidades.php");
                    if (resEsp.ok) {
                ...
                const petsResponse = await fetch(
                    `https://bean-burner-ensures-institutes.trycloudflare.com/backend/actions/getPetsByClientId.php?userId=${userId}`,
                    {
                        method: "GET",
    ...
    const handleActualizarMascota = async () => {
        ...
        try {
            const response = await fetch(
                `https://bean-burner-ensures-institutes.trycloudflare.com/backend/actions/updatePet.php`,
                {
                    method: "POST",
                    headers: { "Content-Type": "application/json" },
