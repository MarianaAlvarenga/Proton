...
const PetImage = ({ petId, mascotaEdit, setMascotaEdit }) => {
        ...
        try {
            ...
            if (petId) {
                const response = await fetch(
                    `https://before-discussion-picked-informational.trycloudflare.com/backend/actions/get_pet_image.php?petId=${petId}`,
                    { credentials: "include" }
                );
    ...
    const handleFileChange = async (event) => {
        ...
        try {
            const response = await fetch(
                "https://before-discussion-picked-informational.trycloudflare.com/backend/actions/upload_pet_image.php",
                {
                    method: "POST",
                    body: formData,
                    credentials: "include"
