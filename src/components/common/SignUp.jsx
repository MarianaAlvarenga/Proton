...
const SignUp = () => {
  ...
  useEffect(() => {
    const fetchRoles = async () => {
      try {
        const res = await fetch("https://independent-intent-telephone-printer.trycloudflare.com/backend/actions/getRoles.php");
    ...
    const fetchEspecialidades = async () => {
      try {
        const res = await fetch("https://independent-intent-telephone-printer.trycloudflare.com/backend/actions/getEspecialidades.php");
        const data = await res.json();
  ...
  const handleSubmit = async (e) => {
    ...
    const endpoint = isEditMode
      ...
      : "https://independent-intent-telephone-printer.trycloudflare.com/backend/actions/auth-chatsito.php";
