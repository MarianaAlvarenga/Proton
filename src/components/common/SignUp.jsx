...
const SignUp = () => {
  ...
  useEffect(() => {
    const fetchRoles = async () => {
      try {
        const res = await fetch("https://sally-paintings-perfectly-procurement.trycloudflare.com/backend/actions/getRoles.php");
    ...
    const fetchEspecialidades = async () => {
      try {
        const res = await fetch("https://sally-paintings-perfectly-procurement.trycloudflare.com/backend/actions/getEspecialidades.php");
        const data = await res.json();
