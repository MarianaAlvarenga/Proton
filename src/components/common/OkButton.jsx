  ...
  const handleClick = async () => {
    if (NameButton === "Finalizar compra") {
      try {
        ...
        if (isRegistered) {
          const checkEmailResponse = await fetch("https://reconstruction-parish-establishing-axis.trycloudflare.com/backend/actions/checkEmail.php", {
            method: "POST",
            headers: {
        ...
        const purchaseResponse = await fetch("https://reconstruction-parish-establishing-axis.trycloudflare.com/backend/actions/completePurchase.php", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
