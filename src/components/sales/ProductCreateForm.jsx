...
const ProductCreateForm = () => {
    ...
    useEffect(() => {
        axios.get('https://allocated-license-collectibles-supporting.trycloudflare.com/backend/actions/getCategories.php')
            .then(response => setCategories(response.data))
            .catch(error => console.error("Hubo un error al obtener las categorías:", error));

        if (productId) {
            axios.get(`https://allocated-license-collectibles-supporting.trycloudflare.com/backend/actions/getProducts.php?id=${productId}`)
                .then(response => {
        ...
        try {
            ...
            if (productId) {
                response = await axios.post(
                    'https://allocated-license-collectibles-supporting.trycloudflare.com/backend/actions/updateProduct.php',
                    data,
                    { headers: { 'Content-Type': 'multipart/form-data' } }
                );
            } else {
                response = await axios.post(
                    'https://allocated-license-collectibles-supporting.trycloudflare.com/backend/actions/addProduct.php',
                    data,
                    { headers: { 'Content-Type': 'multipart/form-data' } }
                );
            }
