    ...
    try {
      ...
      if (isRegistered) {
        const checkEmailResponse = await fetch(
          "https://acknowledged-components-pipe-dominant.trycloudflare.com/backend/actions/checkEmail.php",
          {
            method: "POST",
      ...
      // 👇 guardar carrito
      await axios.post(
        "https://acknowledged-components-pipe-dominant.trycloudflare.com/backend/actions/save_cart.php",
      ...
      const response = await axios.post(
        "https://acknowledged-components-pipe-dominant.trycloudflare.com/backend/actions/create_preference.php",
        {
          items: mpItems,
