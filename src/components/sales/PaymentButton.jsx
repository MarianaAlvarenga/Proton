    ...
    try {
      ...
      if (isRegistered) {
        const checkEmailResponse = await fetch(
          "https://explained-branches-post-lease.trycloudflare.com/backend/actions/checkEmail.php",
          {
            method: "POST",
      ...
      await axios.post(
        "https://explained-branches-post-lease.trycloudflare.com/backend/actions/saveCart.php",
