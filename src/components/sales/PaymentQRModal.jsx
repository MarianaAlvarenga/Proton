...
const PaymentQRModal = ({ paymentDataInput, onClose, redirectToMP = false }) => {
    ...
    const generatePreference = async () => {
      try {
        ...
        const response = await axios.post(
          "https://explained-branches-post-lease.trycloudflare.com/backend/actions/createPreference.php",
          {
  ...
  const checkTurnoPaid = async (turnoId) => {
    try {
      const res = await axios.get(`https://explained-branches-post-lease.trycloudflare.com/backend/actions/getPaymentStatus.php?turnoId=${turnoId}`);
  ...
  const checkPurchasePaid = async (purchaseRef) => {
    try {
      const url = `https://explained-branches-post-lease.trycloudflare.com/backend/actions/get_purchase_payment_status.php?ref=${encodeURIComponent(purchaseRef)}`;
