...
export default function Calendar({
  ...
  const fetchDisponibilidades = (idPeluquero) => {
    ...
    setLoading(true);
    fetch(
      `https://verde-holders-sequences-developers.trycloudflare.com/backend/actions/getAvailabilities.php?id_peluquero=${idPeluquero}`
    )
      .then((res) => {
        if (!res.ok) {
    ...
    if (isAgendarTurno) {
      ...
      try {
        const res = await fetch(
          "https://verde-holders-sequences-developers.trycloudflare.com/backend/actions/saveAppointment.php",
          {
            method: "POST",
  ...
  const handleDeleteTurno = async (turnoId) => {
    try {
      const res = await fetch("https://verde-holders-sequences-developers.trycloudflare.com/backend/actions/deleteAvailability.php", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handleSave = async () => {
    ...
    try {
      const res = await fetch(
        "https://verde-holders-sequences-developers.trycloudflare.com/backend/actions/availability.php",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
